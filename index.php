...
<div class="wrapper">
	<div class="left">
		ZAINAB MEMORIAL Hospital Management System<br><br>(HMS)
	</div>
	<div class="right">
		<h3>Login Here</h3><hr>
		<form action="index.php" method="post">
			<input type="text" class="input" name="E_ID" placeholder="Enter UserID"><br><br>
...
<?php
		extract($_POST);
		if (isset($btn) && !empty($E_ID) && !empty($password)) {
