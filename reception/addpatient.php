	 ...
	 ?>
		<div class="right"><br>
			...
			<center>
				...
				<input type="text" name="sname" class="form" placeholder="Enter Last Name" required="required"><br><br>
				<input type="email" name="email" class="form" placeholder="Enter Email" required="required"><br><br>
				<input type="number" name="phone" class="form" placeholder="Enter Contact" required="required"><br><br>
				...
				<select name="birthyear" class="form" required="required">
                    ...
                    <input type=date name="date" class="form" " required="required"><br><br>
