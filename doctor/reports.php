	 ...
	 ?>
		...
		<div class="statistics">
			...
			$year = date('Y');
				...
				$sql = "SELECT * FROM doctorreport WHERE date='$day' AND month='$month' AND year='$year' AND E_ID='$username'";
			...
			$year = date('Y');
				...
				$sql = "SELECT * FROM doctorreport WHERE  month='$month' AND year='$year' AND E_ID='$username'";
				$query = sqlsrv_query($conn,$sql,$params,$options);
				if (!empty($result)) {
					echo sqlsrv_num_rows($result);
